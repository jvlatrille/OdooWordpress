...
function cyberwareclient_render_clients_page($content)
{
  ...
  $etat = sanitize_text_field($_GET['cybercrudclient'] ?? '');
  $page = max(1, (int) ($_GET['p'] ?? 1));
  $q = sanitize_text_field($_GET['q'] ?? '');

  $html = "<div class='cybercrudclient-ui'>";
  ...
  $html .= "
      <div class='topbar'>
        ...
        <form class='search' method='get'>
          <input type='hidden' name='pagename' value='cyberwareclient'>
  ...
  $html .= "
    ...
    <details class='create-accordion'>
        ...
        <form class='form-grid cybercrudclient-form' method='post' enctype='multipart/form-data'>
